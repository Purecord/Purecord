    ...
    return (
        <SettingsTab>
            ...
            <FormSwitch
                ...
                description="When enabled, Purecord will automatically download and install updates in the background without asking for confirmation. You'll need to restart Discord to apply the changes."
            ...
            <FormSwitch
                ...
                description="Receive a notification when Purecord finishes downloading an update in the background, so you know when to restart Discord."
            ...
            <Paragraph className={Margins.bottom8}>
                This is the GitHub repository where Purecord fetches updates from.
            </Paragraph>
