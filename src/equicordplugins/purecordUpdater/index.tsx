...
const REMOTE_VERSION_URL = `https://api.github.com/repos/Purecord/Purecord/releases/latest`;
...
async function checkForUpdates() {
    try {
        ...
        console.log(`[PurecordUpdater] local=${localVersion} remote=${remoteVersion}`);
        ...
        console.error("[PurecordUpdater] Error:", e);
    }
}
...
function UpdateBanner() {
    ...
    async function doUpdate() {
        ...
        try {
            ...
            setTimeout(() => {
                try {
                    VencordNative.purecord?.relaunch?.();
                } catch {
            ...
            console.error("[PurecordUpdater", e);
    ...
    return React.createElement("div", {
        ...
        React.createElement("div", {
            ...
            React.createElement("span", { style: { fontWeight: 700, flexShrink: 0 } },
                `🔔 Purecord ${info.remoteVersion} available!`
            ),
...
function mountBanner() {
    if (bannerContainer || document.getElementById("purecord-updater-root")) return;
    bannerContainer = document.createElement("div");
    bannerContainer.id = "purecord-updater-root";
    ...
    try {
        ...
        console.error("[PurecordUpdater] Error mounting banner:", e);
    }
}
...
export default definePlugin({
    name: "PurecordUpdater",
    enabledByDefault: true,
    description: "Shows a banner when a new Purecord version is available. Click Update to install.",
